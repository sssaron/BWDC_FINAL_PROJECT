...
<div class="title-card">
  <div class="title-content"
    style="height: {scrollY < 500 ? 150 - (scrollY * 0) : 0}px;
       font-size: {scrollY < 500 ? 6 - (scrollY * 0.0) : 0.0}rem;">
...
@font-face {
  ...
  src: url('C:\Users\hatse\OneDrive\Desktop\KWK_BWDC_Proj\BWDC_FINAL_PROJECT\public\a_another_tag\aAnotherTag.otf') format('opentype');
  font-weight: normal;
  font-style: normal;
}
html, body {
